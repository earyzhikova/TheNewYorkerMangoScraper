...
app.get("/scrape", function(req, res) {
  ...
  request("https://www.newyorker.com/news", function(error, response, html) {
    ...
    $("div[class^='LatestSection__listContainer']").each(function(i, element) {
      ...
      //each card
      console.log($(element).children("[class^='Card__hed']").html());


      // Save the text and href of each link enclosed in the current element
      console.log($(i).html());
      var title = $(element).children("div").text(); //$("a[class^='Card__hed').children("a").text();
      var link = $(element).children("h1").attr("href");
